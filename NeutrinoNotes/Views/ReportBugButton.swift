...
/// report filed from inside Neutrino Notes already knows which app it came from, so the central form's
...
enum BugReport {
    ...
    static let repository = "wcherry/neutrino_notes_ios_mobile"
